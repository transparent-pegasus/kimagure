// This file is created via replace_file_content mainly, but write_to_file is used for new files.
export const privacyContent = {
  en: {
    ...
    introduction:
      "Kimagure (hereinafter referred to as 'Service') establishes this Privacy Policy (hereinafter referred to as 'Policy') regarding the handling of users' personal information.",
  ...
  ja: {
    ...
    introduction:
      "きまぐれごはん（以下、「当サービス」といいます）は、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます）を定めます。",
    lastUpdated: "最終更新日: 2026年2月10日",
